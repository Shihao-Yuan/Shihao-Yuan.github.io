      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-usgs-funding-awarded-first-lead-pi-research-project",
          title: 'USGS Funding Awarded - First Lead-PI Research Project',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/announcement_4/";
            },},{id: "news-new-research-preprint-6c-measurements-for-structural-health-monitoring",
          title: 'New Research Preprint - 6C Measurements for Structural Health Monitoring',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/announcement_3/";
            },},{id: "news-ssa-annual-meeting-session-proposal-accepted",
          title: 'SSA Annual Meeting Session Proposal Accepted',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/announcement_2/";
            },},{id: "news-new-research-preprint-single-station-6c-seismic-source-tracking",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%79%75%61%6E@%6D%69%6E%65%73.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Shihao-Yuan# your GitHub user name", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/shihao-yuan-97843184", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0002-5401-0381", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=NGxVipUAAAAJ", "_blank");
        },
      },{
        id: 'social-wechat_qr',
        title: 'Wechat_qr',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://geophysics.mines.edu/project/yuan-shihao/", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/shihao_yuan", "_blank");
        },
      },{
        id: 'social-youtube',
        title: 'YouTube',
        section: 'Socials',
        handler: () => {
          window.open("https://youtube.com/@shihao666", "_blank");
        },
      },{
      id: 'light-theme',
